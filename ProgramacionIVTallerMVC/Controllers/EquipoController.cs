...
namespace ProgramacionIVTallerMVC.Controllers
{
    public class EquipoController : Controller
    {
        private readonly ProgramacionIVTallerMVCContext _context;

        public EquipoController(ProgramacionIVTallerMVCContext context)
        {
            _context = context;
        }
        ...
        {
            var programacionIVTallerMVCContext = _context.Equipo.Include(e => e.Estadio);
            return View(await programacionIVTallerMVCContext.ToListAsync());
        }
